  ...
  , parseContent: function(val) {
      ...
      if (typeof markdown == 'object') {
        ...
        md.renderer.rules.link_open = function (tokens, idx) {
          ...
          return '<a href="' + escapeHtml(tokens[idx].href) + '"' + title + target + '>' + ( (endsWith(tokens[idx].href, ".md") || endsWith(tokens[idx].href, "/")) || tokens[idx].href.indexOf('.') === -1 ? '' : '<img class="emoji" draggable="false" alt="⬇️" src="//twemoji.maxcdn.com/36x36/2b07.png"> ');
        };
